...
<ul class="boxes">
    <li class="box" id="box1">
        ...
        <img data-original="Images/more-snapshot.png" src="Images/loading.png" class="thumbnail lazy"/>
    ...
    <li class="box" id="box1">
        ...
        <img data-original="Images/more-scheduler.png" src="Images/loading.png"  class="thumbnail lazy"/>
    ...
    <li class="box" id="box2">
        ...
        <img data-original="Images/more-migration.png" src="Images/loading.png"  class="thumbnail lazy"/>
...
<ul class="boxes">
    ...
    <li class="box" id="box2">
        ...
        <img data-original="Images/more-libvirt.png" src="Images/loading.png"  class="thumbnail lazy"/>
    ...
    <li class="box" id="box3">
        ...
        <img data-original="Images/more-xmpp.png" src="Images/loading.png"  class="thumbnail lazy"/>
    ...
    <li class="box" id="box3">
        ...
        <img data-original="Images/more-opensource.png" src="Images/loading.png"  class="thumbnail lazy"/>
